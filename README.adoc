...
If you log in with your acocunt and making changes to the bugs it should be done with the same respect and awareness as if you were using the native Bugzilla interface.
